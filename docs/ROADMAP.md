...
| 1.7 | ~~**Uniform Circular Motion (UCM)**~~ | ~~Constant-speed motion along a circle — introduces angular velocity ω, period T, and frequency f.~~ | ~~**Angular velocity** ω = Δθ/Δt, centripetal acceleration a = ω²·r; plus a [Degrees vs. Radians](../uniform-circular-motion-math-jit/) primer on why angular formulas require radians.~~ |

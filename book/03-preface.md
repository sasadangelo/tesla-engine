...
experiment with parameters while reading.

**How to read this book**

- Chapter 1 covers Physical Quantities & Measurements: the three base quantities (length,
  time, mass), the SI system, unit prefixes, and measurement uncertainty (absolute and
  relative error).
- Chapter 2 covers Uniform Motion: what it is, the governing equations, and worked examples.
- Chapter 3 covers Uniformly Accelerated Motion: constant acceleration from rest, the
  kinematic equations, how position grows quadratically with time, and a step-by-step
  algebraic derivation of the position formula.
- Chapter 4 covers Free Fall: Galileo's experimental result that all objects fall with the
